<div>
    ...
    <div class="p-5 bg-white border rounded-xl shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-200 space-y-3">
        ...
        <div class="flex items-center gap-3">
            ...
            <div class="min-w-0">
                <h3 class="font-semibold text-gray-900 text-lg truncate">{{ $agency->name }}</h3>
        ...
        <div class="flex items-center justify-between pt-1">
            ...
            <div class="flex items-center gap-1 font-bold text-yellow-500">
                ★ <span class="text-gray-800">{{ $agency->averageRating() }}</span>
            </div>
