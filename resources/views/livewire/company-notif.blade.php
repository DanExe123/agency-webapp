<div x-data="{ open: false }" class="relative" wire:poll="loadNotifications">
    <!-- Bell Button -->
                    ...
                    <div class="flex-1 flex flex-col">
                        ...
                        @if(isset($notif['created_at']))
                            <p class="text-xs text-gray-400 mt-1">
                                {{ $notif['created_at']->diffInHours() < 24 ? $notif['created_at']->diffForHumans() : $notif['created_at']->format('M d, Y • h:i A') }}
                            </p>
                        @endif
                    </div>
                </li>
