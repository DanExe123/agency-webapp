<section class="max-w-7xl mx-auto px-6 lg:px-8 py-16 grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
    ...
    <div class="space-y-6" data-aos="fade-up" data-aos-duration="2000">
      ...
      <!-- Search Bar -->
      <div class="bg-white shadow-md rounded-md flex items-center p-2 space-x-2 w-full max-w-xl overflow-hidden">
      ...
      <div class="relative flex-1 flex items-center">
        ...
        <input 
          ...
          class="w-full border-none focus:ring-0 text-sm pl-10 pr-3 py-2"
        >
      </div>
      ...
      <!-- Button -->
      <button class="bg-black text-white px-6 py-2 text-sm font-medium hover:bg-gray-800">
        Find
      </button>
    </div>
